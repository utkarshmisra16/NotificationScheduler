...
namespace EmailSchedulerApp.Repositories.Implementations
{
    public class DashboardRepository : IDashboardRepository
    {
        ...
        public async Task<List<RecentEmailScheduleDto>> GetRecentSchedulesAsync()
        {
            ...
            string query = @"SELECT TOP 10 S.ScheduleId, S.Name, COUNT(R.RecipientId) AS RecipientCount, S.StartDate, S.StartTime, S.IsActive FROM Schedules S LEFT JOIN ScheduleRecipients R ON S.ScheduleId = R.ScheduleId GROUP BY S.ScheduleId, S.Name, S.StartDate, S.StartTime, S.IsActive, S.CreatedOn ORDER BY S.CreatedOn DESC";
